...
(function () {
	...
	app.factory('toastHelp', function (toastr, $rootScope) {
		...
		return {
			...
			error: function error(errors, title, configOverrides) {
			...
			warn: function warn(errors, title, configOverrides) {
				// ensure that errors is an array of strings
				if (typeof errors === 'string') {
					errors = [errors];
				}
			...
			info: function info(messages, title, configOverrides) {
			...
			success: function success(messages, title, persist) {
				// ensure that messages is an array of strings
				if (typeof messages === 'string') {
					messages = [messages];
				}
...
//# sourceMappingURL=toastHelp.js.map
