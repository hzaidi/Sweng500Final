...
angular.module("/routes/organization/organization.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/routes/organization/organization.html",
    "<div class=route-organization-organization ng-controller=\"OrganizationCtrl as route\"><cmpt-topbar-header></cmpt-topbar-header><div class=-g><cmpt-nav-menu class=-u-4-24></cmpt-nav-menu><cmpt-organization-details class=-u-18-24></cmpt-organization-details></div></div>");
}]);
...
angular.module("/routes/setup/programincrement.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/routes/setup/programincrement.html",
    "<div class=route-setup-programincrement ng-controller=\"ProgramincrementCtrl as route\"><cmpt-topbar-header></cmpt-topbar-header><div class=-g><cmpt-nav-menu class=-u-4-24></cmpt-nav-menu><cmpt-program-increment-details class=-u-18-24></cmpt-program-increment-details></div></div>");
}]);

angular.module("/routes/team/list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/routes/team/list.html",
    "<div class=route-team-list ng-controller=\"ListCtrl as route\"><cmpt-topbar-header></cmpt-topbar-header><div class=-g><cmpt-nav-menu class=-u-4-24></cmpt-nav-menu><cmpt-team-list class=-u-18-24></cmpt-team-list></div></div>");
}]);
...
angular.module("/routes/users/scrum-masters.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/routes/users/scrum-masters.html",
    "<div class=route-users-scrum-masters ng-controller=\"ScrumMastersCtrl as route\"><cmpt-topbar-header></cmpt-topbar-header><div class=-g><cmpt-nav-menu class=-u-4-24></cmpt-nav-menu><cmpt-users-list class=-u-18-24></cmpt-users-list></div></div>");
}]);
