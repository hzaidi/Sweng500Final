...
angular.module("/components/login/cmpt-login-sign-up/loginSignUp.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("/components/login/cmpt-login-sign-up/loginSignUp.html",
    "<div class=cmpt-login-sign-up><div class=\"content -g\"><div class=\"-u-12-24 logo\"><cmpt-login-logo></cmpt-login-logo></div><div class=\"-u-12-24 sign-up-form\"><div class=title>Sign Up</div><div class=\"-g two-side-by-side\"><div class=-u-12-24><input class=input placeholder=\"First Name\" name=name></div><div class=-u-12-24><input class=input placeholder=\"Last Name\" name=name></div></div><div><input class=input placeholder=Email name=name></div><div><input class=input placeholder=\"User Id\" name=name></div><div><input type=password class=input placeholder=Password name=name></div><div><input type=password class=input placeholder=Re-Password name=name></div><div><button class=\"button button-positive\">Sign Up</button></div></div></div></div>");
}]);
